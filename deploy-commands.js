...
const commands = [
  ...
  new SlashCommandBuilder().setName('my-songs').setDescription('View your last 10 submissions with stats (Private)'),
  new SlashCommandBuilder().setName('share-my-songs').setDescription('Share your last 10 submissions with stats (Public)'),
  new SlashCommandBuilder()
    .setName('suspend')
  ...
  new SlashCommandBuilder()
    ...
    .addStringOption(option =>
      option
        .setName('genre')
        .setDescription('The Macro Genre')
        .setRequired(true)
        .addChoices(
          ...
          { name: 'Latin & Reggae', value: 'Latin & Reggae' },   // ✅ Added to match taxonomy.json
